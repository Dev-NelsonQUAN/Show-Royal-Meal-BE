...
exports.sendBulkWaitlistEmail = exports.orderStatusMail = exports.sendOrderMail = exports.sendAdminNotificationMail = exports.sendUserWelcomeMail = exports.transporter = void 0;
...
const sendUserWelcomeMail = async (to, name) => {
    const mailContent = `
...
exports.sendUserWelcomeMail = sendUserWelcomeMail;
const sendAdminNotificationMail = async (adminEmail, newUserName, newUserEmail) => {
    const mailContent = `
...
exports.sendAdminNotificationMail = sendAdminNotificationMail;
...
const sendBulkWaitlistEmail = async (recipientEmails, subject, htmlMessage) => {
    console.log(`Starting bulk email job to ${recipientEmails.length} recipients...`);
...
exports.sendBulkWaitlistEmail = sendBulkWaitlistEmail;
